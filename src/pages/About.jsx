        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <motion.div variants={fadeInUp} className="space-y-4 sm:space-y-6">
              ...
              <div className="w-12 sm:w-16 h-[1px] bg-[#A0785A]"></div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <motion.div {...fadeInUp} className="prose prose-lg max-w-4xl mx-auto">
            <div className="space-y-6 sm:space-y-8 text-[#5a4a3a] font-light leading-relaxed">
              ...
              <div className="bg-[#E8DCC8] border-l-4 border-[#8B5A3C] p-6 sm:p-8 my-8 sm:my-12">
                ...
                <p className="text-xs sm:text-sm text-[#8B5A3C] mt-3 sm:mt-4 font-normal tracking-wide">
                  — PreTea Gud Founder
                </p>
              </div>
          ...
          >
            {[
              ...
              >
                ...
                <div className="w-10 sm:w-12 h-[1px] bg-[#A0785A] mb-4 sm:mb-6 group-hover:w-16 transition-all duration-500"></div>
